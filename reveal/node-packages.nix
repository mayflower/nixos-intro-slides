...
let
  sources = {
    ...
    "caniuse-db-1.0.30000745" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-db/-/caniuse-db-1.0.30000745.tgz";
        sha1 = "b259a61737a3e48c4fb4b6b1bc44edeb264cd422";
      };
    };
    "has-ansi-1.0.3" = {
      name = "has-ansi";
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."grunt-contrib-connect-0.11.2" // {
        dependencies = [
          sources."async-0.9.2"
        ];
      })
      sources."grunt-contrib-cssmin-0.14.0"
      sources."grunt-contrib-jshint-0.11.3"
      sources."grunt-contrib-uglify-0.9.2"
      sources."grunt-contrib-watch-1.0.0"
      sources."grunt-sass-1.2.1"
      sources."grunt-retire-0.3.12"
      sources."grunt-zip-0.17.1"
      ...
      sources."caniuse-db-1.0.30000745"
      ...
      sources."connect-livereload-0.5.4"
      ...
      (sources."retire-1.1.6" // {
        dependencies = [
          sources."commander-2.5.1"
        ];
      })
